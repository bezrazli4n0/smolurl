...
--
-- Name: links links_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.links
    ADD CONSTRAINT links_key_key UNIQUE (key);
...
--
-- Name: links fk_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
